        ...
        <div class="card-body">
            ...
            <form novalidate id="note-form">
                <div :class="['form-group', title_error ? 'has-error': '' ]">
                    <label for="note_title"><strong>Note Title</strong></label>
                    <input type="text" name="note_title" @blur="blurNoteTitle" id="note_title" v-model="note.title" class="form-control" placeholder="Enter Note Title">
                    <span :class="['help-block']" v-if="title_error == true"><strong>Note Title field is required.</strong></span>
                </div>
                <div :class="['form-group', body_error ? 'has-error': '' ]">
                    <label for="note_body"><strong>Note Body</strong></label>
                    <textarea rows="10" name="note_body" @blur="blurNoteBody" id="note_body" v-model="note.body" class="form-control" style="resize:none" placeholder="Enter Note Body"></textarea>
                    <span :class="['help-block']" v-if="body_error == true"><strong>The Body field is required.</strong></span>
                </div>
                <div class="form-group">
                    <button type="reset" id="reset" class="btn btn-dark"><i class="fa fa-times"></i></button>
                    <button type="submit" id="save" class="btn btn-primary"><i class="fa fa-save"></i></button>
                </div>
            </form>
        </div>
    </div>
